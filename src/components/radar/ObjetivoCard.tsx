                ...
                <div className="grid gap-3">
                  {krsDoObjetivo.map((kr) => {
                    ...
                    return (
                      <button 
                        key={kr.id} 
                        className="w-full text-left p-3 rounded-lg bg-card border shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-primary/50 transition-colors group"
